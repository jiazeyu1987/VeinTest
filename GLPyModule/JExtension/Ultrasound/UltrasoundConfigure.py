...
class UltrasoundConfigure(ScriptedLoadableModule):

  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "UltrasoundConfigure"  # TODO: make this more human readable by adding spaces
...
class CheckUpItem:
  ...
  def get_solutions(self):
    scriptedModulesPath = os.path.dirname(slicer.util.modulePath("UltrasoundConfigure"))
  ...
  def set_ani(self):
    ...
    pass
#
# UltrasoundConfigureWidget
#

class UltrasoundConfigureWidget(JBaseExtensionWidget):
  old_xpos = 0
  init_once_flag = False
  check_item_list = []
  def setup(self):
    super().setup()
    print("UltrasoundConfigureWidget setup")
  ...
  def set_check_state(self, state_list):
    ...
    util.singleShot(1000,self.auto_next_step)
