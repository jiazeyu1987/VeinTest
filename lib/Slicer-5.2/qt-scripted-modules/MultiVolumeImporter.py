...
class MultiVolumeImporterWidget(ScriptedLoadableModuleWidget):
  ...
  def set_paras(self,directory_path,node,dicom_tag,unit_txt):
    print("sssssssssssssssset")
    self.directory_path = directory_path
    self.multi_node = node
    self.dicomTagText =dicom_tag
    self.unitLabelText = unit_txt
  ...
  def onImportButtonClicked(self):
    ...
    frameLabelsAttr = ''
    frameFileListAttr = ''
    dicomTagNameAttr = self.dicomTagText
    dicomTagUnitsAttr = self.unitLabelText
